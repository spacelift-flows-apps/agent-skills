...
name: flows-app-dev
description: >
  Guidance for building Spacelift Flows apps. Whenever you're working on a
  Flows app (a TypeScript project using @slflows/sdk, with blocks/, main.ts,
  and package.json), ALWAYS load this skill first for app structure, patterns,
  and best practices.
